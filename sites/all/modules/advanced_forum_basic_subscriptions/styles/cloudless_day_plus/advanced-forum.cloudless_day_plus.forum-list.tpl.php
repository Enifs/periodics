  ...
  <div class="forum-table-wrap">
    <div class="forum-table-superheader">
      <div class="forum-table-name">
        ...
        <?php endif; ?>
				<span class="forum-subscribe-global"><?php print $link_subscribe_global; ?></span>
      </div>
      <?php if ($collapsible): ?>
      ...
      <table class="forum-table forum-table-forums">
        <thead class="forum-header">
          <tr>
            ...
            <th class="forum-subscription"><?php print t('Subscription'); ?></th>
          </tr>
        </thead>
          ...
          <?php foreach ($table['items'] as $item_id => $item): ?>
            <?php if ($item->is_container): ?>
              ...
              <?php if (!$item->is_container): ?>
                ...
                <td class="forum-subscribe">
                  <?php print $item->subscribe ?>
                </td>
              <?php endif; ?>
